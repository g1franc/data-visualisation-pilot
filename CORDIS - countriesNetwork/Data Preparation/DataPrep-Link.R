...
Dataset_population  = read.csv("../CORDIS - Datasets/demo_pjan_Data.csv", header=TRUE, sep=",", stringsAsFactors=FALSE, comment.char="")
Dataset_GDP  = read.csv("../CORDIS - Datasets/naida_10_gdp_Data.csv", header=TRUE, sep=",", stringsAsFactors=FALSE, comment.char="")
...
options(scipen = 10)
write.table(Dataset_link, "VisualisedData/NbLink.csv", sep = ";", quote = FALSE)
options(scipen = 0)
...
write.table(Dataset_CountryInformation, "VisualisedData/CountryInformation.csv", sep = ";", quote = FALSE)
